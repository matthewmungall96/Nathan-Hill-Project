...
namespace EmeraldAI.Utility
{
    ...
    public class EmeraldAIEditor : Editor
    {
        ...
        SerializedProperty BehaviorProp, ConfidenceProp, RandomizeDamageProp, DetectionTypeProp, MaxChaseDistanceTypeProp, CombatTypeProp, CreateHealthBarsProp, UseCombatTextProp,
            ...
            WeaponTypeProp, UseRunAttacksProp, ObstructionDetectionQualityProp, AvoidanceQualityProp, UseBlockingProp, BlockingOddsProp, UseAggroProp,
            ...
            UseRandomRotationOnStartProp, UseDeactivateDelayProp, DisableAIWhenNotInViewProp, DeathTypeRefProp, UseDroppableWeaponProp, BackupTypeProp;
        ...
        SerializedProperty HealthBarImageProp, HealthBarBackgroundImageProp, CombatTextFontProp, CombatTextPosProp, BloodEffectProp, Renderer1Prop, Renderer2Prop, Renderer3Prop, 
            ...
            RunAttackCollisionEffectProp, RunAttackImpactSoundProp, AIRendererProp, DroppableWeaponObjectProp;
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (TabNumberProp.intValue == 1)
            {
                ...
                if (TemperamentTabNumberProp.intValue == 4)
                {
                    ...
                    if (self.UseDeactivateDelayRef == EmeraldAISystem.YesOrNo.Yes && self.DisableAIWhenNotInViewRef == EmeraldAISystem.YesOrNo.Yes)
                    {
